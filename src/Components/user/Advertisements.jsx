  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="font-nunito font-semibold text-[30px] leading-[100%] tracking-[0]">
          Advertisements
        </h3>
        <MoreVertical className="w-6 h-6 text-gray-700 cursor-pointer" />
      </div>

      {/* قائمة الإعلانات بنفس تصميم الـ todos */}
      <ul className="space-y-3">
        {mockAds.map((ad, index) => (
          ...
          >
            <span className="font-nunito text-gray-800">{ad}</span>
